...
int main(){
	...
	do{
		...
		printf("\n\007¡Por fin alguien me ve! Soy Carlos, la última persona que habitó esta casa, si quieres salir de aquí, tendrás que demostrar tu ingenio tomando buenas decisiones según se te planteen. En caso de que tomes muchas malas\n decisiones, esta casa se encargará de matarte.\n");
		system("PAUSE");
...
void Instrucciones(char*informacion){
	...
	do{
		...
		if(*informacion=='A'){
			printf("Se trata de preguntas de cultura general tipo trivial en las que tendrás 4 opciones para responde\n Si aciertas estas preguntas ganaras survivals coins que son las monedas existentes en nuestro juego y si no las aciertas las perderás.\n");
